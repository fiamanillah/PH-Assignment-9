    ...
    return (
        <Section className={"bg-lightCard dark:bg-darkCard"}>
            <div className="flex flex-col justify-center text-center items-center max-w-screen-xl py-5 px-[2%] mx-auto">
                <div className="flex w-full justify-between items-start mobile-lg:flex-col mobile-lg:justify-center py-5 mobile-lg:gap-5">
                    <div className="mobile-lg:text-center mobile-lg:w-full mobile-lg:flex mobile-lg:flex-col mobile-lg:items-center">
                        <Link
                            to={'/'}
